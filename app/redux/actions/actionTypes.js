...
// jobs
export const REQUEST_HANDLE_SUBMISSION_CREATE_JOB = "REQUEST_HANDLE_SUBMISSION_CREATE_JOB";
export const REQUEST_ADD_JOB = "REQUEST_ADD_JOB";

// panels
export const REQUEST_REVEAL_PANEL = "REQUEST_REVEAL_PANEL";
export const REQUEST_HIDE_PANEL = "REQUEST_HIDE_PANEL";
export const REQUEST_TOGGLE_PANEL = "REQUEST_TOGGLE_PANEL";
...
export const REQUEST_HIDE_NOTIFICATION = "REQUEST_HIDE_NOTIFICATION";
export const RECEIVE_HIDE_NOTIFICATION = "RECEIVE_HIDE_NOTIFICATION";
...
// export const REQUEST_SAVE_JOB = "REQUEST_SAVE_JOB";
...
// export const RECEIVE_REVEAL_PANEL = "RECEIVE_REVEAL_PANEL";
// export const RECEIVE_HIDE_PANEL = "RECEIVE_HIDE_PANEL";
